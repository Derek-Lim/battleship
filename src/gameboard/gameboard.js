...
export default function Gameboard() {
  ...
  const placeShip = (ship, {x, y}, orientation) => {
    ...
    for (const [tx, ty] of targets) board[ty][tx].placeShip(ship)
  ...
  return { getPublicView, receiveAttack, placeShip, allSunk }
}
...
function Cell() {
  ...
  return { hasShip, placeShip, isAttacked, attack }
}
